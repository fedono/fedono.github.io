...
![img](../assets/imgs/how-browsers-works/build-dom.png)
...
![img](../assets/imgs/how-browsers-works/token.png)
...
![img](../assets/imgs/how-browsers-works/state-machine.png)
...
- 实现一个解析DOM结构的 Parser [github:html-parser](https://github.com/aimergenge/toy-html-parser ) 

  这个实现了上述 winter 需要实现的能够解析 html 的解析器

- 以上内容来自 winter 的《重学前端》系列